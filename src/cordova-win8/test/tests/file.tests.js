describe('File API', function() {
    ...
    describe('LocalFileSystem', function() {
        ...
        /*describe('window.resolveLocalFileSystemURI', function() {
            ...
            it("resolve valid file name with parameters", function() {
                var fileName = "resolve.file.uri.params.txt",
                win = jasmine.createSpy().andCallFake(function(fileEntry) {
                    expect(fileEntry).toBeDefined();
                    expect(fileEntry.name).toBe(fileName);
            ...
            it("should error out when resolving invalid file name", function() {
                ...
                runs(function () {
                    ...
                    //window.resolveLocalFileSystemURI("file:///C:/Application1/Application1/js", win, fail);
    ...
    /*describe('DirectoryReader interface', function() {
        describe("readEntries", function() {
            ...
            it("should read contents of directory that has been removed", function() {
                var dirName = "de.createReader.notfound.dir",
                    dirPath = root.fullPath + '\\' + dirName,
    ...
    describe('Entry', function() {
        ...
        it("copyTo: file", function() {
            var file1 = "entry.copy.file1.txt",
                file2 = "entry.copy.file2.txt",
        ...
        it("copyTo: file onto itself", function() {
            var file1 = "entry.copy.fos.file1.txt",
                entryCallback = jasmine.createSpy().andCallFake(function(entry) {
        ...
        it("copyTo: directory", function() {
            var file1 = "file1.txt",
                srcDir = "entry.copy.srcDir.dir",
                dstDir = "entry.copy.dstDir.dir",
        ...
        it("copyTo: directory to backup at same root directory", function() {
            var file1 = "file1.txt",
                srcDir = "entry.copy.srcDirSame.dir",
                dstDir = "entry.copy.srcDirSame-backup.dir",
                dstPath = root.fullPath + '\\' + dstDir,
                filePath = dstPath + '\\' + file1,
        ...
        it("copyTo: directory onto itself", function() {
            var file1 = "file1.txt",
                srcDir = "entry.copy.dos.srcDir.dir",
        ...
        it("copyTo: directory into itself", function() {
            var srcDir = "entry.copy.dis.srcDir.dir",
                dstDir = "entry.copy.dis.dstDir.dir",
                fail = createFail('Entry'),
                win = createWin('Entry'),
                srcPath = root.fullPath + '\\' + srcDir,
                entryCallback = jasmine.createSpy().andCallFake(function(directory) {
        ...
        it("copyTo: directory that does not exist", function() {
            var file1 = "entry.copy.dnf.file1.dir", 
                dstDir = "entry.copy.dnf.dstDir.dir",
        ...
        it("copyTo: invalid target name", function() {
            var file1 = "entry.copy.itn.file1.txt",
                file2 = "bad:file:name.txt",
                filePath = root.fullPath + '\\' + file1,
                fail = createFail('Entry'),
                win = createWin('Entry'),
                entryCallback = jasmine.createSpy().andCallFake(function(entry) {
        ...
        it("moveTo: file to same parent", function() {
            var file1 = "entry.move.fsp.file1.txt",
                file2 = "entry.move.fsp.file2.txt",
        ...
        it("moveTo: file to new parent", function() {
            var file1 = "entry.move.fnp.file1.txt",
        ...
        it("moveTo: directory to same parent", function() {
            var file1 = "file1.txt",
                srcDir = "entry.move.dsp.srcDir.dir",
                dstDir = "entry.move.dsp.dstDir.dir",
                srcPath = root.fullPath + '\\' + srcDir,
                dstPath = root.fullPath + '\\' + dstDir,
                filePath = dstPath + '\\' + file1,
                win = createWin('Entry'),
        ...
        it("moveTo: directory to same parent with same name", function() {
            var file1 = "file1.txt",
                srcDir = "entry.move.dsp.srcDir.dir",
                dstDir = "entry.move.dsp.srcDir-backup.dir",
                srcPath = root.fullPath + '\\' + srcDir,
                dstPath = root.fullPath + '\\' + dstDir,
                filePath = dstPath + '\\' + file1,
                win = createWin('Entry'),
        ...
        it("moveTo: directory to new parent", function() {
            var file1 = "file1.txt",
                srcDir = "entry.move.dnp.srcDir.dir",
                dstDir = "entry.move.dnp.dstDir.dir",
                srcPath = root.fullPath + '\\' + srcDir,
                dstPath = root.fullPath + '\\' + dstDir,
                filePath = dstPath + '\\' + file1,
                win = createWin('Entry'),
        ...
        it("moveTo: directory onto itself", function() {
            var file1 = "file1.txt",
                srcDir = "entry.move.dos.srcDir.dir",
                srcPath = root.fullPath + '\\' + srcDir,
                filePath = srcPath + '\\' + file1,
                fail = createFail('Entry'),
                win = createWin('Entry'),
        ...
        it("moveTo: directory into itself", function() {
            var srcDir = "entry.move.dis.srcDir.dir",
                dstDir = "entry.move.dis.dstDir.dir",
                srcPath = root.fullPath + '\\' + srcDir,
                win = createWin('Entry'),
                fail = createFail('Entry'),
                entryCallback = jasmine.createSpy().andCallFake(function(directory) {
        ...
        it("moveTo: file onto itself", function() {
            var file1 = "entry.move.fos.file1.txt",
                filePath = root.fullPath + '\\' + file1,
                win = createWin('Entry'),
                fail = createFail('Entry'),
                entryCallback = jasmine.createSpy().andCallFake(function(entry) {
        ...
        it("moveTo: file onto existing directory", function() {
            var file1 = "entry.move.fod.file1.txt",
                dstDir = "entry.move.fod.dstDir.dir",
                subDir = "subDir.dir",
        ...
        it("moveTo: directory onto existing file", function() {
            var file1 = "entry.move.dof.file1.txt",
                srcDir = "entry.move.dof.srcDir.dir",
        ...
        it("copyTo: directory onto existing file", function() {
            var file1 = "entry.copy.dof.file1.txt",
                srcDir = "entry.copy.dof.srcDir.dir",
                dirPath = root.fullPath + '\\' + srcDir,
                filePath = root.fullPath + '\\' + file1,
                win = createWin('Entry'),
                fail = createFail('Entry'),
        ...
        it("moveTo: directory onto directory that is not empty", function() {
            var srcDir = "entry.move.dod.srcDir.dir",
                dstDir = "entry.move.dod.dstDir.dir",
                subDir = "subDir.dir",
                srcPath = root.fullPath + '\\' + srcDir,
        ...
        it("moveTo: file replace existing file", function() {
            var file1 = "entry.move.frf.file1.txt",
                file2 = "entry.move.frf.file2.txt",
        ...
        it("moveTo: directory replace empty directory", function() {
            var file1 = "file1.txt",
                srcDir = "entry.move.drd.srcDir.dir",
                dstDir = "entry.move.drd.dstDir.dir",
                srcPath = root.fullPath + '\\' + srcDir,
                dstPath = root.fullPath + '\\' + dstDir,
                win = createWin('Entry'),
                fail = createFail('Entry'),
        ...
        it("moveTo: directory that does not exist", function() {
            var file1 = "entry.move.dnf.file1.txt", 
                dstDir = "entry.move.dnf.dstDir.dir",
                filePath = root.fullPath + '\\' + file1,
                dstPath = root.fullPath + '\\' + dstDir,
                win = createWin('Entry'),
                fail = createFail('Entry'),
        ...
        it("moveTo: invalid target name", function() {
            var file1 = "entry.move.itn.file1.txt",
                file2 = "bad:file:name.txt",
                filePath = root.fullPath + '\\' + file1,
                win = createWin('Entry'),
                fail = createFail('Entry'),
    ...
    describe('read method', function(){
        it("should read file properly, File object", function() {
            ...
            var fileName = "reader.txt",
                ...
                verifier = jasmine.createSpy().andCallFake(function(evt) {
                    ...
                    expect(String(evt.target.result).trim()).toBe(String(rule).trim());
                }),
        ...
        it("should read file properly, Data URL", function() {
            ...
            var fileName = "reader.txt",
                ...
                // file content
                //rule = "There is an exception to every rule.  Except this one.",
                rule = "uiwyeroiugfyqcajkds897945234==";
                // creates a FileWriter object
                create_writer = function(fileEntry) {
                    fileEntry.createWriter(write_file, fail);
                },
    ...
    describe('FileWriter', function(){
        ...
        it("should be able to write and append to file, createWriter", function() {
            var fileName = "writer.append.txt",
                theWriter,
                filePath = root.fullPath + '\\' + fileName,
                // file content
        ...
        it("should be able to seek to the middle of the file and write more data than file.length", function() {
            var fileName = "writer.seek.write.txt",
                filePath = root.fullPath + '\\' + fileName,
                theWriter,
                // file content
        ...
        it("should be able to seek to the middle of the file and write less data than file.length", function() {
            var fileName = "writer.seek.write2.txt",
                filePath = root.fullPath + '\\' + fileName,
                // file content
                rule = "This is our sentence.",
                theWriter,
        ...
        it("should write and read special characters", function() {
            var fileName = "reader.txt",
                ...
                verifier = jasmine.createSpy().andCallFake(function(evt) {
                    expect(evt).toBeDefined();
                    expect(String(evt.target.result).trim()).toBe(rule);
                    // cleanup
                    deleteFile(fileName);
                }),
                // writes file and reads it back in
        ...
        it("should be able to truncate", function() {
            var fileName = "writer.truncate.txt",
                rule = "There is an exception to every rule.  Except this one.",
                //rule = "1234567890123456789012345678901234567890",
                fail = createFail('FileWRiter'),
                theWriter,
                // writes file content 
                write_file = function(fileEntry) {

...
// Register pause, resume, online, offline and deviceready channels as events on document.
channel.onPause = cordova.addDocumentEventHandler('pause');
channel.onResume = cordova.addDocumentEventHandler('resume');
channel.onOnline = cordova.addDocumentEventHandler('online');
channel.onOffline = cordova.addDocumentEventHandler('offline');
...
// Event to indicate a offline lifecycle event
channel.create('onOffline');

// Event to indicate a online lifecycle event
channel.create('onOnline');
...
Entry.prototype.getMetadata = function(successCallback, errorCallback) {
    var success = typeof successCallback !== 'function' ? null : function (lastModified) {
        console.log("this is the time :" + lastModified.modificationTime);
      var metadata = new Metadata(lastModified.modificationTime);
  ...
  exec(success, fail, "File", "getMetadata", [this.fullPath,this.isFile]);
};
...
Entry.prototype.moveTo = function(parent, newName, successCallback, errorCallback) {
    ...
    // copy
    exec(success, fail, "File", "moveTo", [srcPath, parent.fullPath, name, this.isFile]);
};
...
Entry.prototype.copyTo = function(parent, newName, successCallback, errorCallback) {
    ...
    // copy
    exec(success, fail, "File", "copyTo", [srcPath, parent.fullPath, name,this.isFile]);
};
...
Entry.prototype.remove = function(successCallback, errorCallback) {
    ...
    exec(successCallback, fail, "File", "remove", [this.fullPath, this.isFile]);
};
    ...
    find:function(fields, successCB, errorCB, options) {
        ...
        if (!fields.length) {
            ...
            var win = function(result) {
                ...
                var jsonContact = JSON.stringify(cs);

                var arrContact = [];
                arrContact.push(jsonContact);
                successCB(arrContact)
                //successCB(cs);
            };
...
module.exports = function(status,callbackId,args,cast) {
    ...
    try
    {
        ...
        console.log("The call back args are parsed");
    }
    catch(ex)
    {
    ...
    try
    {
        ...
        //parsedArgs.latitude = JSON.parse(parsedArgs.latitude);
        //console.log("latitude value :" + parsedArgs.latitude);
    }
    catch(ex)
    {
